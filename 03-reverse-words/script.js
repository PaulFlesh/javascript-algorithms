...
function reverseWords(str) {
  str = str.split(' '); // Создаем из строки массив, элементы которого разделены пробелом
  str = str.reverse(); // Переписываем элементы массива в обратном порядке
  str = str.join(" "); // Соединяем полученные элементы пробелом
  return str;
}
